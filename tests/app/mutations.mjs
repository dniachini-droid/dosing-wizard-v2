...
export const MUTATIONS = [
     ...
     -------------------------------------------------------------------- */
  {
    ...
    find: "  return row.time ? localTimeZoneUnknown(row.date, row.time) : dateOnly(row.date);",
    replace: '  return localTimeZoneUnknown(row.date, row.time || "00:00");',
  ...
  },
  {
    ...
    file: "app/src/store/import-v1.js",
    find: 'import { dateOnly, localTimeZoneUnknown } from "./time.js";',
    replace: 'import { dateOnly, exactInstant as localTimeZoneUnknown } from "./time.js";',
  ...
  },
  {
    ...
    file: "app/src/store/import-v1.js",
    find: "    if (stated[key] !== undefined && stated[key] !== n) {",
    replace: "    if (false) {",
    breaks: ["IMP-10"],
  },
  {
